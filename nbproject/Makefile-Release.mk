...
${OBJECTDIR}/bsearch.o: bsearch.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bsearch.o bsearch.c

${OBJECTDIR}/bsearch_run.o: bsearch_run.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bsearch_run.o bsearch_run.c

${OBJECTDIR}/list.o: list.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list.o list.c
...
${OBJECTDIR}/test_run.o: test_run.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_run.o test_run.c

${OBJECTDIR}/tree.o: tree.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tree.o tree.c
...
${TESTDIR}/tests/list_test.o: tests/list_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/list_test.o tests/list_test.c
...
${OBJECTDIR}/bsearch_nomain.o: ${OBJECTDIR}/bsearch.o bsearch.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bsearch_nomain.o bsearch.c;\
	else  \
...
${OBJECTDIR}/bsearch_run_nomain.o: ${OBJECTDIR}/bsearch_run.o bsearch_run.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bsearch_run_nomain.o bsearch_run.c;\
	else  \
...
${OBJECTDIR}/list_nomain.o: ${OBJECTDIR}/list.o list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list_nomain.o list.c;\
	else  \
...
${OBJECTDIR}/test_run_nomain.o: ${OBJECTDIR}/test_run.o test_run.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_run_nomain.o test_run.c;\
	else  \
...
${OBJECTDIR}/tree_nomain.o: ${OBJECTDIR}/tree.o tree.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tree_nomain.o tree.c;\
	else  \
